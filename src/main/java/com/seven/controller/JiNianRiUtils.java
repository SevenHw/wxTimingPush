...
public class JiNianRiUtils {
    ...
    public static int getLianAi(String ingDate){
        return calculationLianAi(ingDate);
    }
    public static int getBirthday_Jo(String meetDate){
        try {
            return calculationBirthday(meetDate);
